...
public class PhysInf extends AppCompatActivity
{
    ...
    private EditText emailEntry, phEntry, nameEntry, practiceEntry;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        practiceEntry = (EditText) findViewById(R.id.newPractice);
        ...
        confirmInfo.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                final String prac = practiceEntry.getText().toString().trim();
                String userId = auth.getUid();
                ...
                if (TextUtils.isEmpty(prac))
                {
                    Toast.makeText(getApplicationContext(), "Enter practice name", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                mDatabase.child("Physicians").child(userId).child("info").setValue(new User(lastName, mail, phoneNumber,prac)).addOnCompleteListener(new OnCompleteListener<Void>()
                {
                    @Override
                    public void onComplete(@NonNull Task<Void> task)
                    {
